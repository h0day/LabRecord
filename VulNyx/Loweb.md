...
2025-03-16 https://vulnyx.com/

[video](https://www.bilibili.com/video/BV1nqQaYbEu5/?spm_id_from=333.1387.homepage.video_card.click&vd_source=aed2f374c732513d2e535afafb1fd2ec)
...
将生成的代码拼接到 lang 后面，执行后得到了反弹的 shell。

进入系统枚举，发现 /opt/monitor.sh 里面有用户名和密码：
...
切换到 r3dh4ck 发现 user.txt 没有权限，sudo -l 显示 (ALL) NOPASSWD: /usr/bin/chown 直接修改文件所属主:

```
sudo /usr/bin/chown r3dh4ck:r3dh4ck user.txt
r3dh4ck@loweb:~$ cat user.txt
